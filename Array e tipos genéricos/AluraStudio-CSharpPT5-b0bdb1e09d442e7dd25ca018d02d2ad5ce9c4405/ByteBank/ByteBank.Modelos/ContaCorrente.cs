...
namespace ByteBank.Modelos
{
    ...
    public class ContaCorrente
    {
        ...
        /// <exception cref="ArgumentException">Essa exceção lançada quando um valor negativo é utilizado no argumento</exception>
        ...
        {
            //return "Número " + Numero + ", Agência " + ", Saldo " + Saldo ; Outra maneira
